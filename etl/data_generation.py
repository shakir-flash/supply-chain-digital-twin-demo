# etl/data_generation.py
import random, numpy as np, pandas as pd
from config import (RAW_DIR, FACILITY_SEEDS, STORE_METROS, N_STORES, MAX_STORE_PER_METRO,
...
def generate_transport(dcs_df, stores_df):
    rows = []
...
def run():
    ...
    transport_raw = generate_transport(dcs_raw.drop_duplicates("dc_id"),
                                       stores_raw.drop_duplicates("store_id"))
