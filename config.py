...
SEMANTIC_DIR = DATA_DIR / "semantic_docs"
for p in [DATA_DIR, RAW_DIR, CLEAN_DIR, RESULTS_DIR, CHARTS_DIR, SEMANTIC_DIR]:
...
# Facility seeds (representative US sites / types)
FACILITY_SEEDS = [
...
# Major US metros to seed stores
STORE_METROS = [
